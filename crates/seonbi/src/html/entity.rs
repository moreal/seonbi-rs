...
impl HtmlEntity {
    ...
    pub fn with_tag_stack(self, new_stack: HtmlTagStack) -> Self {
        match self {
            ...
            HtmlEntity::EndTag { tag, .. } => HtmlEntity::EndTag {
                tag_stack: new_stack,
                tag,
            },
            HtmlEntity::Text { raw_text, .. } => HtmlEntity::Text {
                tag_stack: new_stack,
                raw_text,
            },
            HtmlEntity::Cdata { text, .. } => HtmlEntity::Cdata {
                tag_stack: new_stack,
                text,
            },
            HtmlEntity::Comment { comment, .. } => HtmlEntity::Comment {
                tag_stack: new_stack,
                comment,
            },
        }
